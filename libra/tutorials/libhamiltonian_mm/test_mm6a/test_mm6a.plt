...
set ylabel "Energy, a.u." offset 0.5, 0.0
set xrange [0:0.5]
set xtics 0.1

set key at 0.5, -1

set output "_en_cooling.png"
plot "_en_cooling.txt" using ($2/200.0):4   w lp  ls 11  lw 3  t "E_{kin}",\
     "_en_cooling.txt" using ($2/200.0):6   w lp  ls 21  lw 3  t "E_{pot}",\
     "_en_cooling.txt" using ($2/200.0):8   w lp  ls 31  lw 3  t "E_{tot}"
...
set output "_en_md.png"
plot "_en_md.txt" using ($2/20.0):4   w lp  ls 11  lw 3  t "E_{kin}",\
     "_en_md.txt" using ($2/20.0):6   w lp  ls 21  lw 3  t "E_{pot}",\
     "_en_md.txt" using ($2/20.0):8   w lp  ls 31  lw 3  t "E_{tot}"
